...
{
	public static var updateVersion:String = MainMenuState.psychEngineVersion; // Original Psych update check disabled for the Sigma Engine fork
	...
	override function update(elapsed:Float)
	{
		if(!leftState) {
			if (controls.ACCEPT) {
				leftState = true;
				CoolUtil.browserLoad("https://github.com/ShadowMario/FNF-PsychEngine/releases/tag/1.0.4");
			}
